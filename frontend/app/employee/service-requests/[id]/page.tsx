                ...
                <div className="flex-1 overflow-y-auto mb-6 space-y-4">
                  ...
                  <div className="flex justify-end">
                    <div className="max-w-[75%]">
                      ...
                      <div className="rounded-lg p-3 bg-green-500 text-white rounded-tr-none">
                        <p className="text-sm whitespace-pre-wrap">
                          {request.description}
                        </p>
                        <div className="mt-2 pt-2 border-t border-green-400 text-sm space-y-1">
                  ...
                  {request.comments?.map((comment: any, index: number) => {
                    const isOwn = comment.user?._id === request.createdBy?._id;
                    return (
                      <div
                        key={index}
                        className={`flex ${
